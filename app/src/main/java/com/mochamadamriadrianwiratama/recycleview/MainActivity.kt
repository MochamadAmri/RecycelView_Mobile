package com.mochamadamriadrianwiratama.recycleview
...
import com.mochamadamriadrianwiratama.recycleview.adapter.AdapterTeamBola
import com.mochamadamriadrianwiratama.recycleview.databinding.ActivityMainBinding
import com.mochamadamriadrianwiratama.recycleview.model.Pemain
        ...
        binding.list.adapter = AdapterTeamBola(this,listPemain,object :AdapterTeamBola.onClickListener {
            override fun detailData(item: Pemain?) {
                Dialog(this@MainActivity).apply {
                    ...
                    val tagllahir = this.findViewById<TextView>(R.id.txtTanggalLahir)
                    ...
                    tagllahir.text = "${item?.tanggallahir}"
